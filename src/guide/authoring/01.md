...
```yaml
{{#include 01_code.md:step_03}}
```

## Output

In addition to the rendering capabilities we'll begin exploring in [Structuring an Archetype](02.md), 
